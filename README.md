...
1. This is a template repository: Create your own repository from this template. Give it a name. 
2. Clone your repository to your computer. (Open Folder from Git)
3. In CONSOLE: Type `quarto render` to produce the website. 
...
5. Explore the different HTML-page types in the HTML but also in their source type:
    ...
    - A slidedeck in the "Presentation"
